...
export class TutorialGuideUI extends BaseUI {
  ...
  private createUI(): void {
    ...
    if (this.baseNode) {
      this.container.setparent(this.baseNode);
    }
  ...
  private createMaskLayer(): void {
    ...
    this.maskLayer.setparent(this.container);
  }
  ...
  private createTooltip(): void {
    ...
    this.tooltipContainer.setparent(this.container);
    ...
    background.setparent(this.tooltipContainer);
    ...
    this.tooltipTitle.setparent(this.tooltipContainer);
    ...
    this.tooltipContent.setparent(this.tooltipContainer);

    // 下一步按钮
    this.nextButton = new Button();
    this.nextButton.set_name("NextButton");
    this.nextButton.text = "下一步";
    this.nextButton.setparent(this.tooltipContainer);
    ...
    this.skipButton.setparent(this.tooltipContainer);
  ...
  private createProgressIndicator(): void {
    ...
    this.progressIndicator.setparent(this.container);
  }
