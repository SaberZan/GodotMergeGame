...
export class UIMgr extends Singleton<UIMgr> {
    ...
    public async Init(): Promise<boolean> {
        ...
        if (rootHandle) {
            ...
            if (this.uiRoot != null) {
                this.uiRoot.setparent(App.node);
            ...
            if (layerHandle) {
                ...
                this.staticUI.setparent(this.uiRoot);
                ...
                this.dynamicUI.setparent(this.uiRoot);
                ...
                this.dialogUI.setparent(this.uiRoot);
                ...
                this.toastUI.setparent(this.uiRoot);
                ...
                this.tutorialUI.setparent(this.uiRoot);
                ...
                this.loadingUI.setparent(this.uiRoot);
    ...
    public AddLayer(baseUILayer: BaseUILayer) {
        ...
        if (parent)
            baseUILayer.baseNode.setparent(parent);
        this.AddFullScreenRectTransform(baseUILayer.baseNode);
    }
