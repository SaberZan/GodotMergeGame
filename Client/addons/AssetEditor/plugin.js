...
let AssetEditorPlugin = (() => {
    let _classDecorators = [bind(), bind.tool()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = godot_1.EditorPlugin;
    var AssetEditorPlugin = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            AssetEditorPlugin = _classThis = _classDescriptor.value;
        ...
        _enter_tree() {
            ...
            let scene = godot_1.ResourceLoader.load("res://addons/AssetEditor/main_panel.tscn");
            this.dock = scene.instantiate();
    ...
    return AssetEditorPlugin = _classThis;
})();
exports.default = AssetEditorPlugin;
