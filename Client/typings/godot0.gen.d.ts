...
declare module "godot" {
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_performance.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_engine.html  
     */
    class Engine extends Object {
         ...
         *    
         *  See [url=https://docs.godotengine.org/en/4.6/tutorials/plugins/running_code_in_the_editor.html]Running code in the editor[/url] in the documentation for more information.  
         *      
         ...
         *      
         *  **Note:** Consider enabling [url=https://docs.godotengine.org/en/4.6/tutorials/physics/interpolation/index.html]physics interpolation[/url] if you change [member physics_ticks_per_second] to a value that is not a multiple of `60`. Using physics interpolation will avoid jittering when the monitor refresh rate and physics update rate don't exactly match.  
         */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_projectsettings.html  
     */
    class ProjectSettings extends Object {
        ...
        /** Gets an array of the settings which have been changed since the last save. Note that internally `changed_settings` is cleared after a successful save, so generally the most appropriate place to use this method is when processing [signal settings_changed]. */
        static get_changed_settings(): PackedStringArray
        ...
        static check_changed_settings_in_group(setting_prefix: string): boolean
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_os.html  
     */
    class OS extends Object {
         ...
         *  On the Linux/BSD platform, this path can be overridden by setting the `XDG_CONFIG_HOME` environment variable before starting the project. See [url=https://docs.godotengine.org/en/4.6/tutorials/io/data_paths.html]File paths in Godot projects[/url] in the documentation for more information. See also [method get_cache_dir] and [method get_data_dir].  
         ...
         *  On the Linux/BSD platform, this path can be overridden by setting the `XDG_DATA_HOME` environment variable before starting the project. See [url=https://docs.godotengine.org/en/4.6/tutorials/io/data_paths.html]File paths in Godot projects[/url] in the documentation for more information. See also [method get_cache_dir] and [method get_config_dir].  
         *  Not to be confused with [method get_user_data_dir], which returns the  *project-specific*  user data path.  
         */
        static get_data_dir(): string
        
        /** Returns the  *global*  cache data directory according to the operating system's standards.  
         *  On the Linux/BSD platform, this path can be overridden by setting the `XDG_CACHE_HOME` environment variable before starting the project. See [url=https://docs.godotengine.org/en/4.6/tutorials/io/data_paths.html]File paths in Godot projects[/url] in the documentation for more information. See also [method get_config_dir] and [method get_data_dir].  
         *  Not to be confused with [method get_user_data_dir], which returns the  *project-specific*  user data path.  
         */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_time.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_textservermanager.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_navigationserver2dmanager.html  
     */
    class NavigationServer2DManager extends Object {
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_physicsserver2dmanager.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_navigationserver3dmanager.html  
     */
    class NavigationServer3DManager extends Object {
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_physicsserver3dmanager.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_navigationmeshgenerator.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_ip.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_geometry2d.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_geometry3d.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_resourceloader.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_resourcesaver.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_classdb.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_marshalls.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_translationserver.html  
     */
    class TranslationServer extends Object {
        ...
        static get_plural_rules(locale: string): string
        ...
        static get_translations(): GArray<Translation>
        
        /** Returns the [Translation] instances in the main translation domain that match [param locale] (see [method compare_locales]). If [param exact] is `true`, only instances whose locale exactly equals [param locale] will be returned. */
        static find_translations(locale: string, exact: boolean): GArray<Translation>
        
        /** Returns `true` if there are any [Translation] instances in the main translation domain that match [param locale] (see [method compare_locales]). If [param exact] is `true`, only instances whose locale exactly equals [param locale] are considered. */
        static has_translation_for_locale(locale: string, exact: boolean): boolean
        
        /** Returns `true` if the main translation domain contains the given [param translation]. */
        static has_translation(translation: Translation): boolean
        ...
        static format_number(number: string, locale: string): string
        
        /** Returns the percent sign used in the given [param locale]. */
        static get_percent_sign(locale: string): string
        
        /** Converts [param number] from the numeral system used in the given [param locale] to Western Arabic (0..9). */
        static parse_number(number: string, locale: string): string
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_input.html  
     */
    class Input extends Object {
         ...
         *      
         *  **Note:** Due to keyboard ghosting, [method is_key_pressed] may return `false` even if one of the action's keys is pressed. See [url=https://docs.godotengine.org/en/4.6/tutorials/inputs/input_examples.html#keyboard-events]Input examples[/url] in the documentation for more information.  
         */
         ...
         *      
         *  **Note:** Due to keyboard ghosting, [method is_physical_key_pressed] may return `false` even if one of the action's keys is pressed. See [url=https://docs.godotengine.org/en/4.6/tutorials/inputs/input_examples.html#keyboard-events]Input examples[/url] in the documentation for more information.  
         */
         ...
         *      
         *  **Note:** Due to keyboard ghosting, [method is_action_just_pressed] may return `false` even if one of the action's keys is pressed. See [url=https://docs.godotengine.org/en/4.6/tutorials/inputs/input_examples.html#keyboard-events]Input examples[/url] in the documentation for more information.  
         *      
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_inputmap.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_enginedebugger.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_gdextensionmanager.html  
     */
    class GDExtensionManager extends Object {
        ...
        /** Loads the extension already in address space via the given path and initialization function. The [param path] needs to be unique and start with `"libgodot://"`. Returns [constant LOAD_STATUS_OK] if successful. */
        static load_extension_from_function(path: string, init_func: int64): GDExtensionManager.LoadStatus
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_resourceuid.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_workerthreadpool.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_themedb.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_editorinterface.html  
     */
    class EditorInterface extends Object {
         ...
         *  - [member Viewport.gui_embed_subwindows] is `false`. This is forced to `true` on platforms that don't support multiple windows such as Web, or when the `--single-window` [url=https://docs.godotengine.org/en/4.6/tutorials/editor/command_line_tutorial.html]command line argument[/url] is used.  
         */
         ...
         */
        static set_object_edited(object: Object, edited: boolean): void
        
        /** Returns `true` if the object has been marked as edited through [method set_object_edited]. */
        static is_object_edited(object: Object): boolean
        ...
        static add_root_node(node: Node): void
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_javaclasswrapper.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_javascriptbridge.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_audioserver.html  
     */
    class AudioServer extends Object {
         ...
         */
        static set_input_device_active(active: boolean): Error
        
        /** Returns the number of frames available to read using [method get_input_frames]. */
        static get_input_frames_available(): int64
        ...
        static get_input_buffer_length_frames(): int64
         ...
         */
        static get_input_frames(frames: int64): PackedVector2Array
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_cameraserver.html  
     */
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_displayserver.html  
     */
    class DisplayServer extends Object {
         ...
         *  The names of built-in display servers are `Windows`, `macOS`, `X11` (Linux), `Wayland` (Linux), `Android`, `iOS`, `web` (HTML5), and `headless` (when started with the `--headless` [url=https://docs.godotengine.org/en/4.6/tutorials/editor/command_line_tutorial.html]command line argument[/url]).  
         */
        static get_name(): string
         ...
         */
        static window_set_color(color: Color): void
         ...
         */
        static accessibility_create_sub_text_edit_elements(parent_rid: RID, shaped_text: RID, min_height: float64, insert_pos?: int64 /* = -1 */, is_last_line?: boolean /* = false */): RID
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_nativemenu.html  
     */
    class NativeMenu extends Object {
         ...
         */
        static get_system_menu_text(menu_id: NativeMenu.SystemMenus): string
        
        /** Sets the text of the system menu item.  
         *      
         *  **Note:** This method is implemented on macOS.  
         */
        static set_system_menu_text(menu_id: NativeMenu.SystemMenus, name: string): void
     ...
     *  	  
     *  @link https://docs.godotengine.org/en/4.6/classes/class_renderingserver.html  
     */
    class RenderingServer extends Object {
         ...
         */
        static material_set_use_debanding(enable: boolean): void
         ...
         */
        static multimesh_instances_reset_physics_interpolation(multimesh: RID): void
        ...
        static environment_set_tonemap_agx_contrast(env: RID, agx_contrast: float64): void
        ...
        static environment_set_ssr_half_size(half_size: boolean): void
        ...
        static canvas_item_add_ellipse(item: RID, pos: Vector2, major: float64, minor: float64, color: Color, antialiased?: boolean /* = false */): void
        ...
        /** Sets a boot image. The [param color] defines the background color. The value of [param stretch_mode] indicates how the image will be stretched (see [enum SplashStretchMode] for possible values). If [param use_filter] is `true`, the image will be scaled with linear interpolation. If [param use_filter] is `false`, the image will be scaled with nearest-neighbor interpolation. */
        static set_boot_image_with_stretch(image: Image, color: Color, stretch_mode: RenderingServer.SplashStretchMode, use_filter?: boolean /* = true */): void
        
        /** Sets a boot image. The [param color] defines the background color. The value of [param scale] indicates if the image will be scaled to fit the screen size. If [param use_filter] is `true`, the image will be scaled with linear interpolation. If [param use_filter] is `false`, the image will be scaled with nearest-neighbor interpolation. */
